...
#include "qSlicerNeedleTrackerModuleWidgetsExport.h"

class qSlicerFooBarWidgetPrivate;

/// \ingroup Slicer_QtModules_NeedleTracker
class Q_SLICER_MODULE_NEEDLETRACKER_WIDGETS_EXPORT qSlicerFooBarWidget
  : public QWidget
{
  Q_OBJECT
public:
